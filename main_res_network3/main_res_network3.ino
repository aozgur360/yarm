...
//=========================================================
//pin assignments
const byte light_control = 30;  
const byte miniscope_trigger = 46; 
const byte Tone0 = 47;  
const byte Tone1 = 49;  
...
void setup()
{
    pinMode(miniscope_trigger, OUTPUT);
    ...
    digitalWrite(light_control, LOW);   // turn the LED on (HIGH is the voltage level)
    digitalWrite(miniscope_trigger, LOW);   // turn the LED on (HIGH is the voltage level)
