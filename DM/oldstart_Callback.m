...
fprintf(arduino,'%c',['q' round(str2double(app.reward_pulse_C.Value))]);
pause(0.05);
fprintf(arduino,'%c',['v' round(str2double(app.reward_pulse_L.Value))]);
pause(0.05);
fprintf(arduino,'%c',['w' round(str2double(app.reward_pulse_R.Value))]);
pause(0.05);
